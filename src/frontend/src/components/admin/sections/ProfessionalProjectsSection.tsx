...
import {
  useCreateProfessionalProject,
  useDeleteProfessionalProject,
  useProfessionalProjects,
  useUpdateProfessionalProject,
} from "../../../hooks/useQueries";
import DeleteConfirm from "../DeleteConfirm";
import ProjectForm from "../ProjectForm";

export default function ProfessionalProjectsSection() {
  const { data: projects, isLoading } = useProfessionalProjects();
  const createMutation = useCreateProfessionalProject();
  const updateMutation = useUpdateProfessionalProject();
  const deleteMutation = useDeleteProfessionalProject();
  ...
  return (
    <div data-ocid="admin.professional-projects.section">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button
          ...
          data-ocid="admin.professional-projects.primary_button"
      ...
      {isLoading ? (
        <div
          className="space-y-3"
          data-ocid="admin.professional-projects.loading_state"
        >
          {[1, 2, 3].map((i) => (
        ...
        <div
          ...
          data-ocid="admin.professional-projects.empty_state"
        >
        ...
        <div className="space-y-2" data-ocid="admin.professional-projects.list">
          {projects?.map((project, index) => (
            <div
              key={project.id}
              data-ocid={`admin.professional-projects.item.${index + 1}`}
            ...
            >
              ...
              <div className="flex items-center gap-2 ml-4 flex-shrink-0">
                <Button
                  ...
                  data-ocid={`admin.professional-projects.edit_button.${index + 1}`}
                ...
                <Button
                  ...
                  data-ocid={`admin.professional-projects.delete_button.${index + 1}`}
